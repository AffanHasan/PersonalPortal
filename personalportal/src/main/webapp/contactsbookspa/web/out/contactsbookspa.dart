...
void init_autogenerated() {
  ...
  __e26 = __root.nodes[7].nodes[3];
  __t.conditional(__e26, () => showCCG, (__t) {
    var __e25;
    __e25 = __html0.clone(true);
    __t.loop(__e25, () => contactsBook.keys, ($list, $index, __t) {
      var groupName = $list[$index];
      var __e1, __e23, __e24;
      ...
      __e23 = __e24.nodes[3];
      __t.bind(() => groupName,  (__e) { __e23.id = '${__e.newValue}_contacts_list'; }, false);
      __t.loopIterateAttr(__e23, () => contactsBook['$groupName'], ($list, $index, __t) {
        var contact = $list[$index];
        var __e10, __e15, __e20, __e21, __e22, __e3, __e5;
  ...
  __e27 = __root.nodes[11].nodes[1].nodes[3];
  __t.listen(__e27.onClick, ($event) { closeGeneralDialog(); });
  __t.create();
  __t.insert();
}
